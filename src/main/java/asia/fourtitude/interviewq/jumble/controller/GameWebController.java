...
public class GameWebController {
    ...
    public String doGetNew(@ModelAttribute(name = "board") GameBoard board) {
        /*
         * TODO:
         * a) Assign the created game `state` (with randomly picked word) into game
         * `board` (session attribute)
    ...
    public String doPostPlay(
        ...
        boolean correct = board.getState().updateGuessWord(guess);
        if (!correct) {
